...
final class PhpModeTest extends TestCase {
	...
	public function testInitializeUpdater(): Updater {
		$updater = new Updater(self::$db, __DIR__ . '/test-updates.php', Updater::MODE_PHP);
	...
	public function testCreateUpdate(Updater $updater): void {
		...
		$updateFileContents = include __DIR__ . '/test-updates.php';
	...
	public static function tearDownAfterClass(): void {
		...
		unlink(__DIR__ . '/test-updates.php');
	}
}
