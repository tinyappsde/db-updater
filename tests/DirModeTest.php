...
final class DirModeTest extends TestCase {
	...
	public static function setUpBeforeClass(): void {
		...
		mkdir(__DIR__ . '/test-updates');
	}

	public function testInitializeUpdater(): Updater {
		$updater = new Updater(self::$db, __DIR__ . '/test-updates');
	...
	public function testCreateUpdate(Updater $updater): void {
		...
		$updateFileContents = file_get_contents(__DIR__ . '/test-updates/unit-test-update.sql');
		$this->assertEquals(implode("\n", $queries), $updateFileContents);
	}
	...
	public static function tearDownAfterClass(): void {
		...
		unlink(__DIR__ . '/test-updates/unit-test-update.sql');
		rmdir(__DIR__ . '/test-updates');
	}
}
